...
t[#t+1] = LoadFont("Combo numbers")..{
	...
	Condition=not STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):FullCombo()
};
t[#t+1] = LoadFont("FC numbers")..{
	...
	Condition=STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):FullCombo()
};
t[#t+1] = LoadFont("_resultLbl")..{
